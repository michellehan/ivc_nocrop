...
parameters = {
	...
	"val-dir" 	    : "/data/IVC_180814/IVC_Filter_Images/test",
    	...
    	"train-csv"         : "/data/IVC_180814/IVC_Filter_Images/labels/trainGroupedAll3_labels.csv", #10 classes
    	"val-csv"         : "/data/IVC_180814/IVC_Filter_Images/labels/testGroupedAll3_labels.csv",
