...
parameters = {
	...
	"train-csv" 	    : "/data/IVC_180814/IVC_Filter_Images/labels/trainGroupedAll2_labels.csv", #10 classes
	"val-csv" 	    : "/data/IVC_180814/IVC_Filter_Images/labels/testGroupedAll2_labels.csv",
